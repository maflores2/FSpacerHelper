using FSpacerHelper.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace FSpacerHelper.Data
{
    public class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var spacerCards = new SpacerCard[]
            {
                ...
                new SpacerCard{HorizontalGearCaseDeviation = 0, HorizontalCarrierDeviation = 0, Bearing = 3, HMDGear = 6.032f, VerticalGearCaseDeviation = -3, VerticalCarrierDeviation = 3, GearMount = 0, VMDGear = 2.999f, DriveNumber = "326294", OperatorID = 3 , Date = DateTime.ParseExact("20160708", "yyyyMMdd", null), Active = true, Backlash = .011f, HorizontalSetting = .003f, OutputSetting = -.004f, HelicalGearNumber = "", HelicalPinionNumber = ""}
            };
